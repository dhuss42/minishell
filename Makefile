...
#    Updated: 2024/10/25 10:10:48 by maustel          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CFILES = executor.c executor_utils.c find_path.c exec_free.c error_handling.c check_files.c redirections.c exec_pipe.c heredoc.c exec_main.c
